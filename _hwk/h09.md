...
<li style="margin-bottom:8em;" markdown="1"> (20 pts) There is a recommended "form" for a user story.   One application that each of you has used in order to be in this class is UCSB's GOLD system, the system used to register for classes.  Give three examples of user stories, in the proper form recommended by the web pages that you were supposed to read for this assignment.
